    ...
    <section className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:block-screen *:before:inline-px *:before:inset-bs-0 *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:block-px *:after:inline-screen *:after:-inset-bs-px *:after:inset-s-0 md:*:p-10">
            <article>

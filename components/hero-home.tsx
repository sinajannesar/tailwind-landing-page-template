...
const AVATARS = [
  { src: Avatar01, alt: "Avatar 01" },
  { src: Avatar02, alt: "Avatar 02" },
  { src: Avatar03, alt: "Avatar 03" },
  { src: Avatar04, alt: "Avatar 04" },
  { src: Avatar05, alt: "Avatar 05" },
  { src: Avatar06, alt: "Avatar 06" },
];
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          <div className="pb-12 text-center md:pb-16">
            <div
              className={`mb-6 border-y ${BORDER_GRADIENT}`}
              data-aos="zoom-y-out"
            >
            ...
            <h1
              className={`mb-6 border-y text-5xl font-bold ${BORDER_GRADIENT} md:text-6xl`}
              data-aos="zoom-y-out"
              data-aos-delay={150}
            >
            ...
            <div className="mx-auto max-w-3xl">
              ...
              <div className={`relative before:absolute before:inset-0 before:border-y before:${BORDER_GRADIENT}`}>
                <div
